...
def test_run_fc2_fc3_aln_ridge(
    ...
    fc3 = np.array(
        [
            [
                [
                    [-2.82053981e00, 8.31869659e-01, -4.17408392e-01],
                    [-1.72211598e-01, 5.44649784e-01, 1.19517657e-01],
                    [6.13354509e-02, 1.54420712e-01, 6.29939825e-01],
                ],
                [
                    [-1.72211598e-01, 5.44649784e-01, 1.19517657e-01],
                    [7.98930129e-01, 4.80818547e-01, 7.48878705e-02],
                    [-2.24590636e-02, 1.32223797e-03, 1.19865372e-01],
                ],
                [
                    [6.13354509e-02, 1.54420712e-01, 6.29939825e-01],
                    [-2.24590636e-02, 1.32223797e-03, 1.19865372e-01],
                    [7.78601093e-01, 2.21763448e-01, -3.45698231e-01],
                ],
            ],
            [
                [
